...
describe("Header", () => {
    beforeEach(function () {
        ...
        cy.get('.p-nav__list > :nth-child(1)').as("OurWriters")
        cy.get('.p-nav__list > :nth-child(2)')
        
    })
    context("Link Active", function () {
        it("Our Writers", function () {
            // cy.get("@OurWriters").as("OurWriters")
            cy.get("@OurWriters").contains("Our Writers").click({ force: true })
    ...
    context("Check UI", function () {
        ...
        context("How It Works", function () {
            ...
            it.only("Check font-weight ", function () {
                cy.get('.p-nav__list > :nth-child(2)').as("ab")
                cy.get("'@ab'+'>a'")
                 .should('have.css', 'font-weight', this.Header.FontWeight)
            })
            it("Check font-size ", function () {
